...
class CurlTransfer(Transfer):
    ...
    def perform(self, url):
        ...
        self._curl.setopt(pycurl.HTTPPOST, self._data)
        self._curl.setopt(pycurl.WRITEDATA, out)
        self._curl.setopt(pycurl.HTTPHEADER, ['content-type: multipart/form-data'])
